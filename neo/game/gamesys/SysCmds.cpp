...
void idGameLocal::InitConsoleCommands( void ) {
	...
	cmdSystem->AddCommand( "ecsExperimentalProbe",	Cmd_ECSExperimentalProbe_f,	CMD_FL_GAME|CMD_FL_CHEAT,	"experimental EnTT ECS: status or 'ecsExperimentalProbe event <msg>'" );
